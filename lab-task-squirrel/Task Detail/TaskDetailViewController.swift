...
class TaskDetailViewController: UIViewController {
    ...
    private func updateUI() {
        ...
        let color: UIColor = task.isComplete ? .systemPurple : .tertiaryLabel
...
//        viewPhoto.isHidden = !task.isComplete
        ...
        // Set the Attach Photo button color to purple
        attachPhotoButton.backgroundColor = .systemPurple
        attachPhotoButton.setTitleColor(.white, for: .normal)  // White text for contrast
        attachPhotoButton.layer.cornerRadius = 8 // Optional: Rounded corners
    }
